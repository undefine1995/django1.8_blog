#coding:utf-8
"""
Django settings for Undefine project.
...
SECRET_KEY = 'go$symyv-ryx#bl41*$151#1knw1@bhvd%-xl3u*e93l#k*m5$'
...
WSGI_APPLICATION = 'Undefine.wsgi.application'
